...
caminho_arquivo_entrada = os.path.join(projeto_raiz, 'arquivos-xlsx', "BD-Combinado.xlsx")
caminho_arquivo_saida = os.path.join(projeto_raiz, "DB.xlsx")
...
MAPA_NOME_PARA_SIGLA = {
    ...
    'sao paulo': 'SP', 'sergipe': 'SE', 'tocantins': 'TO', "brasil": "DF"
}

# Gera a lista de siglas e o mapa para numérico a partir do dicionário acima
SIGLAS_ESTADOS = sorted(list(set(MAPA_NOME_PARA_SIGLA.values())))
...
def processar_dados_localidade(arquivo_entrada, arquivo_saida):
    ...
    print("✅Coluna Localidade(s) Atualizada para UF com Sucesso!!")
